...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    final appBarContent = Center(
      child: Padding(
        padding: kIsWeb
            ? EdgeInsets.zero
            : (removePadding == true ? EdgeInsets.zero : MediaQuery.of(context).padding),
  ...
  Widget _buildTitle() {
    ...
    /// TODO(BRN):
    /// Separar responsabilidades da app bar:
    ///
    /// Atualmente mistura:
    /// - navegação
    /// - search state visual
    /// - integração ProductManager
    /// - renderização dinâmica de título
    ///
    /// Futuramente dividir em:
    /// - app_bar_title_builder
    /// - app_bar_search_button
    /// - app_bar_navigation_button
    /// - app_bar_search_state
    ///
    /// OBS:
    /// ProductManager NÃO deveria ser consumido
    /// diretamente pela app bar principal.
  }
