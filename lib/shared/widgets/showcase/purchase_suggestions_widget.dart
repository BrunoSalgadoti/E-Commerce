...
class PurchaseSuggestionsWidget extends StatefulWidget {
  ...
  const PurchaseSuggestionsWidget(
      {super.key,
      this.titleText = 'Quem comprou este produto, também levaram estes...',
      this.fontSize});
        ...
        child: Column(
          ...
          children: [
            textForGoogleDecorations(
                titleForDecorations: widget.titleText,
...
// TODO(BRN): separar camada de recomendação.
//
// PurchaseSuggestionsWidget atualmente depende
// diretamente de PurchaseModel.getPurchaseSuggestions(),
// criando acoplamento entre UI e regra de negócio.
//
// Ideal futuro:
// - PurchaseRecommendationService
// - PurchaseRecommendationRepository
// - Provider/Manager específico
//
// Widget deve apenas renderizar dados.
//
// OBS:
// manter funcionamento atual até estabilizar
