...
/// TODO(BRN):
/// Remover instanciação direta de UserManager.
///
/// Atualmente:
/// UserManager()
///
/// Futuramente:
/// obter estado via Provider/context.
///
/// Objetivo:
/// evitar múltiplas instâncias silenciosas
/// do gerenciamento de usuário.

/// TODO(BRN):
/// Separar responsabilidades do card:
///
/// Atualmente o widget:
/// - renderiza UI
/// - executa navegação
/// - valida imagens
/// - trata fallback
/// - verifica estado admin
///
/// Futuramente:
/// mover regras auxiliares
/// para helpers/builders específicos.