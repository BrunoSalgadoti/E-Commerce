...
import 'package:brn_ecommerce/shared/constants/assets/root_assets.dart' show RootAssets;
...
/// TODO(BRN):
/// Remover uso de `dynamic image`.
///
/// Criar tipagem explícita:
///
/// Opção 1:
/// - String? imageUrl
/// - File? imageFile
///
/// Opção 2:
/// Criar ImageSource sealed class/factory.
///
/// PRIORIDADE:
/// média
///
/// OBS:
/// Widget já possui boa separação:
/// - loading
/// - fallback
/// - network
/// - file local
///
/// Excelente candidato para padronização global
/// das imagens do projeto.